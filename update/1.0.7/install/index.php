...
class awz_dealsproductfield extends CModule {

    var $MODULE_ID = "awz.dealsproductfield";
    var $MODULE_VERSION;
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage("AWZ_DEALSPRODUCTFIELD_MODULE_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("AWZ_DEALSPRODUCTFIELD_MODULE_DESCRIPTION");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("AWZ_DEALSPRODUCTFIELD_MODULE_NAME"),
    ...
    function DoUninstall()
    {
        ...
        if($step < 2) {
            $APPLICATION->IncludeAdminFile(
                Loc::getMessage('AWZ_DEALSPRODUCTFIELD_INSTALL_TITLE'),
